function frame_fd = MIMO_Rx_signal_to_fd(signal_td, fr_len, cp_length, null_subcarriers)
...
for id_r = 1:size(signal_td,2)
    frame_fd_full(:,id_r) = fft(remove_cyclic_prefix(signal_td(:,id_r), cp_length))./fr_len;
end
