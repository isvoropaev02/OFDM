...
info_frame_td_noise = [awgn(complex(info_frame_td_channel(:,1)), SNR_dB-10*log10(2), 'measured') awgn(complex(info_frame_td_channel(:,2)), SNR_dB, 'measured')];
pilots_frame_td_noise = [awgn(complex(pilots_frame_td_channel(:,1)), SNR_dB-10*log10(2), 'measured') awgn(complex(pilots_frame_td_channel(:,2)), SNR_dB, 'measured')];
